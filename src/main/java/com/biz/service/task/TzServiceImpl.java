 ...
 */
@Service("tzService")
public class TzServiceImpl extends BaseServiceImpl<Twxgoods> implements TzServiceI {
    ...
    public String closeOrder() throws Exception {
        ...
        System.out.print("结束关闭订单TZ"+DateUtil.dateToString(new Date()));
        return ss;
    }
