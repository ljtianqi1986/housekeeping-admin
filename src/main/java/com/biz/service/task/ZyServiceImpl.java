 ...
 */
@Service("zyService")
public class ZyServiceImpl extends BaseServiceImpl<Twxgoods> implements ZyServiceI {
 ...
 String ss= "ok";
         System.out.print("进入自动关闭订单ZY"+DateUtil.dateToString(new Date()));
        //获取超时订单
        ...
        System.out.print("结束关闭订单ZY"+DateUtil.dateToString(new Date()));
        return ss;
    }
