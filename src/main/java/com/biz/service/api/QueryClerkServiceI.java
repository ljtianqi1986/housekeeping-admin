 ...
 */
public interface QueryClerkServiceI extends BaseServiceI<TorderMain> {
...
List<HashMap<String,Object>> queryClerkByShopWithPhone(String shop_id) throws Exception;
    ...
    int int_sum(Map<String,Object> map)throws Exception;

    List<Base90Detail> selectOrtherBalanceOut(Map<String,Object> map)throws Exception;

    int out_sum(Map<String,Object> map) throws Exception;
