...
public class SmsTencent
{
	...
	{
		SmsSender sender = new SmsSender(1400026932, "7a8de5724356d8ddcdffc61c678966e6");
		sender.sendMsg("86", phone, content+"为您的登录验证码，请于3分钟内填写。如非本人操作，请忽略本短信。");
	}
	public static void sendMsgForShops(String phone,String content)
	{
		SmsSender sender = new SmsSender(1400026932, "7a8de5724356d8ddcdffc61c678966e6");
		sender.sendMsg("86", phone, content);
	}
	public static void main(String[] args)
	{
		// 开放者实际发送短信时请使用申请的 sdkappid 和 appkey
		SmsSender sender = new SmsSender(1400019055, "093f5137b3c7c4d40b94da7edd88a9fa");
		sender.sendMsg("86", "15050746353", "123456为您的登录验证码，请于3分钟内填写。如非本人操作，请忽略本短信。");
	}
}
...
class SmsSender
{
	...
	public void sendMsg(String nationCode, String phoneNumber, String content)
	{
		...
		String wholeUrl = String.format("%s?sdkappid=%d&random=%d", url,
				sdkappid, rnd);
		try
		{
